 ...
 *  - The scan runs every shipped detector (46 files currently) across all non-test
 *    TypeScript sources, exactly as the live plugin does post-write.
 */
export const baseline: Readonly<Record<string, ReadonlyArray<string>>> = {
	...
	'packages/module-typescript/src/index.ts': ["casting-awareness", "prefer-option-over-null", "require-effect-concurrency", "stream-large-files"],
	...
	'src/index.ts': ["avoid-any", "avoid-direct-json", "avoid-direct-tag-checks", "casting-awareness", "effect-promise-vs-trypromise", "prefer-option-over-null", "require-effect-concurrency", "use-console-service"],
};
